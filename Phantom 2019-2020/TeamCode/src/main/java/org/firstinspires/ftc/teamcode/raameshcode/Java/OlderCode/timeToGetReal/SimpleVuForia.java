package org.firstinspires.ftc.teamcode.raameshcode.Java.OlderCode.timeToGetReal;
...
import org.firstinspires.ftc.teamcode.raameshcode.Java.OlderCode.Controllers.MethodsWithoutVuforia;
import org.firstinspires.ftc.teamcode.raameshcode.Java.OlderCode.Controllers.ProtoReduxController;
...
@Autonomous(name = "AXR")
public class SimpleVuForia extends LinearOpMode {

    MecanumConfig robot = new MecanumConfig();
    ProtoReduxController reduxController = new ProtoReduxController();
        ...
        while (!isStopRequested()) {
            ...
            if (targetVisible) {
                ...
                telemetry.addData("Rot (deg)", "{Roll, Pitch, Heading} = %.0f, %.0f, %.0f", rotation.firstAngle, rotation.secondAngle, rotation.thirdAngle)                                                                                                                                 ;
                    if (translation.get(1) < 0.5/mmPerInch && translation.get(1) > -0.5/mmPerInch) {
                        break                                                                                                                                                                                                                                                               ;
                    }
            }
            else {
