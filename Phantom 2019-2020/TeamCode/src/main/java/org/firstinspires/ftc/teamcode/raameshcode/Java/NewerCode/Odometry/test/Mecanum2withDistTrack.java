...
@TeleOp(name = "New TeleOP with Distance Tracking")
public class Mecanum2withDistTrack extends LinearOpMode {

    MecanumConfig robot = new MecanumConfig();

    Odemetry Odometry = new Odemetry("Odo");
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && !robot.imu.isGyroCalibrated() && !robot.imu.isAccelerometerCalibrated())
        {
            sleep(50);
            idle();
        }
        ...
        while (!isStopRequested()) {
            ...
            telemetry.addData("Distance",Odometry.distance);
